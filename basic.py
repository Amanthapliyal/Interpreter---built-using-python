...
class RTError(Error):
    ...
    def generate_traceback(self):
        ...
        while ctx:
            result = f'{pos.fn}, line{str(pos.ln + 1)}, in {ctx.display_name}\n' + result
...
class Lexer:
    ...
    def make_identifier(self):
        ...
        tok_type = TT_KEYWORD if id_str in KEYWORDS else TT_IDNETIFIER
...
###################################
    ...
    def expr(self):
        ...
        if self.current_tok.matches(TT_KEYWORD,'VAR'):
            ...
            if self.current_tok.type != TT_IDNETIFIER:
                return res.failure(InvalidSyntaxError(
                    self.current_tok.pos_start, self.current_tok.pos_end,
                    "EXPECTED IDENTIFIER"
                ))
